...
// import { Calendar, MapPin, Chrome as Home, CircleCheck as CheckCircle, Clock, TriangleAlert as AlertTriangle, ArrowRight, Search, FileText } from 'lucide-react-native';
...
//   const stats = [
//     { label: 'Pending Handovers', value: '5', color: '#f59e0b', icon: Clock },
//     { label: 'Completed Today', value: '3', color: '#059669', icon: CheckCircle },
//     { label: 'On Hold', value: '2', color: '#dc2626', icon: AlertTriangle },
//   ];
...
//                   <Text style={styles.detailText}>Possession: {currentFlat.possession_date}</Text>
//                 </View>
//               </View>
...
//               <Text style={styles.noFlatTitle}>No Active Assignment</Text>
//               <Text style={styles.noFlatText}>Search for an application to start the handover process</Text>
//               <TouchableOpacity 
//                 style={styles.searchButton}
//                 onPress={() => router.push('/(tabs)/search')}
//               >
//                 <Text style={styles.searchButtonText}>Search Applications</Text>
//               </TouchableOpacity>
//             </View>
//           </View>
//         )}
...
//               <Text style={styles.actionText}>Search Flat</Text>
//             </TouchableOpacity>
//             <TouchableOpacity 
//               style={styles.actionCard}
