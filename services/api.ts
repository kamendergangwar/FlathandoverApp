...
const API_BASE_URL = process.env.EXPO_PUBLIC_API_BASE_URL || 'http://localhost/rest-api/applicationservice';
...
export const authAPI = {
  login: (username: string, password: string) =>
    api.post(`/Snagging/login?username=${username}&password=${password}`),
};
