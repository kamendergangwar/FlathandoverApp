...
const translations: { en: Translation; mr: Translation } = {
  en: {
    ...
    'search_options': 'Search Options',
    'search_help_text': 'You can search for flats using either the application number or the registered mobile number.',
    'search_help_text_extended': 'You can search for flats using application number, registered mobile number, or by scanning a barcode.',
    'example_formats': 'Example formats:',
    'barcode': 'Barcode',
    'scan': 'Scan',
    'scan_barcode': 'Scan Barcode',
    'scan_barcode_or_enter': 'Scan barcode or enter manually',
    'scan_application_barcode': 'Scan application barcode',
    'position_barcode_in_frame': 'Position the barcode within the frame to scan',
    'camera_permission_required': 'Camera permission is required to scan barcodes',
    'please_scan_barcode': 'Please scan a barcode or enter application number manually',
    'no_flat_found_app': 'No flat found with this application number',
    'no_flat_found_mobile': 'No flat found with this mobile number',
    'please_enter_application': 'Please enter an application number',
    'please_enter_mobile': 'Please enter a mobile number',
  ...
  mr: {
    ...
    'search_options': 'शोध पर्याय',
    'search_help_text': 'तुम्ही अर्ज क्रमांक किंवा नोंदणीकृत मोबाइल नंबर वापरून फ्लॅट शोधू शकता.',
    'search_help_text_extended': 'तुम्ही अर्ज क्रमांक, नोंदणीकृत मोबाइल नंबर किंवा बारकोड स्कॅन करून फ्लॅट शोधू शकता.',
    'example_formats': 'उदाहरण स्वरूप:',
    'barcode': 'बारकोड',
    'scan': 'स्कॅन',
    'scan_barcode': 'बारकोड स्कॅन करा',
    'scan_barcode_or_enter': 'बारकोड स्कॅन करा किंवा मॅन्युअली प्रविष्ट करा',
    'scan_application_barcode': 'अर्ज बारकोड स्कॅन करा',
    'position_barcode_in_frame': 'स्कॅन करण्यासाठी बारकोड फ्रेममध्ये ठेवा',
    'camera_permission_required': 'बारकोड स्कॅन करण्यासाठी कॅमेरा परवानगी आवश्यक आहे',
    'please_scan_barcode': 'कृपया बारकोड स्कॅन करा किंवा अर्ज क्रमांक मॅन्युअली प्रविष्ट करा',
    'no_flat_found_app': 'या अर्ज क्रमांकासह कोणताही फ्लॅट सापडला नाही',
    'no_flat_found_mobile': 'या मोबाइल नंबरसह कोणताही फ्लॅट सापडला नाही',
    'please_enter_application': 'कृपया अर्ज क्रमांक प्रविष्ट करा',
    'please_enter_mobile': 'कृपया मोबाइल नंबर प्रविष्ट करा',
...
const mockFlats: Flat[] = [
  {
    ...
    floor: 1,
    possession_date: '2024-02-15',
    project: 'Kharghar Bus Terminous',
    mobileNumber: '+91 98765 43210',
    status: 'pending'
  },
  {
